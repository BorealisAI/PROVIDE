...
### Test
You will need at least one GPU to run tests. We used GeForce GTX 1080 Ti GPU. Use the following commands to test the models:
 
- Bouncing Balls 4 balls/binary
```bash
python scripts/test.py --batch_size 1 --datapath ../bb_binary/ --model_name bb_binary --T 6  --K 5
```
...
```bash
python scripts/test.py --batch_size 1 --datapath ../bb_color/ --model_name bb_color --T 6  --K 5
```

- Bouncing Balls  4-8 balls/binary
```bash
python scripts/test.py --batch_size 1 --datapath ../bb_binary678/ --gt_datapath ../bb_color678/ --model_name bb_binary --T 6  --K 9 --max_num_frames 10
```

- Bouncing Balls  4-8 balls/colored/ colors
```bash
python scripts/test.py --batch_size 1 --datapath ../bb_color678/ --gt_datapath ../bb_color678/ --model_name bb_color --T 6  --K 9 --max_num_frames 10
```
- Bouncing Balls  4-8 balls/colored/4 colors
```bash
python scripts/test.py --batch_size 1 --datapath ../bb_color678_4_colors/ --gt_datapath ../bb_color678/ --model_name bb_color --T 6  --K 9 --max_num_frames 10
```

- CLEVRER 3-5 objects
```bash
python scripts/test.py --batch_size 1 --datapath ../clevrer345/ --gt_datapath ../clevrer345masks/ --model_name clevrer --T 5  --K 6
```
- CLEVRER 6 objects
```bash
python scripts/test.py --batch_size 1 --datapath ../clevrer6/ --gt_datapath ../clevrer6masks/ --model_name clevrer --T 5  --K 6
```
...
```bash
python scripts/train.py --batch_size 32 --max_num_frames 4 --datapath ../bb_binary/ --model_name bb_binary --T 6  --K 5
```
- Bouncing balls color
```bash
python scripts/train.py --batch_size 32 --max_num_frames 4 --param_schedule --datapath ../bb_color/ --model_name bb_color_train --T 6  --K 5
```

- CLEVRER
```bash
python scripts/train.py --batch_size 32 --max_num_frames 4 --param_schedule --datapath ../clevrer/ --gt_datapath ../clevrer/ --model_name clevrer --T 5  --K 6
```
